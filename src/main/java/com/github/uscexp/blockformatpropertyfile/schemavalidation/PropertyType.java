...
public enum PropertyType {
	STRING("string", String.class), DATE("date", ValidateableDate.class), LONG("long", Long.class), DOUBLE("double", Double.class), BOOLEAN("boolean", Boolean.class), TYPE("type", Reference.class);
